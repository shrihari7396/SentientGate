...
public class CircuitBreakerConfig {
    ...
    /**
     * Configure the circuit breaker for AI Service Feign Client.
    ...
    public CircuitBreaker aiServiceCircuitBreaker(CircuitBreakerRegistry circuitBreakerRegistry) {
        io.github.resilience4j.circuitbreaker.CircuitBreakerConfig config = 
                ...
                .slowCallDurationThreshold(Duration.ofSeconds(2)) // Calls taking more than 2 seconds are considered slow
                .waitDurationInOpenState(Duration.ofSeconds(10)) // Wait 10 seconds before trying again
                .permittedNumberOfCallsInHalfOpenState(3) // Allow 3 calls in half-open state
                .minimumNumberOfCalls(5) // Minimum 5 calls before evaluating the failure rate
